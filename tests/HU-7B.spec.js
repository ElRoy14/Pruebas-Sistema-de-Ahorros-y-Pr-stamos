...
describe("Duración de la Inversión B", () => {
    it("No debe de realizarse ningún calculo y debe presentarse un "
    + "mensaje de error para que todos los campos sean llenados correctamente.", async () => {
        ...
        fs.writeFileSync('./screenshots/Duración de la Inversión B.png', screenshot, 'base64');
        console.log('Captura de pantalla tomada y guardada como Duración de la Inversión B.png');
